...
| Field | Value |
| --- | --- |
| Source SHA used for run | `1f3343314c7598934d0bcd6537ccc9dfeed86efb` |
...
| B JEV shadow | 1 | 1.00 | 1.00 | 0 | 933.838 ms | 0 ms | 0 ms | execution unchanged |
| C JEV active cold | 1 | 0.50 | 0.00 | 1 | 859.270 ms | 300 ms | **-559.270 ms** | mandatory only; all optional skipped |
